...
export default function About(props) {
  ...
  return (
    <>
      ...
      <div className="container"   style={{backgroundColor:props.myMode==='dark'? '#042743':'white',color:props.myMode==='dark'?'white':'black'}}>
        ...
        <div className="accordion" id="accordionExample">
          <div className="accordion-item">
            ...
            >
              <div className="accordion-body"   style={{backgroundColor:props.myMode==='dark'? '#042743':'white',color:props.myMode==='dark'?'white':'black'}}>
          ...
          <div className="accordion-item"  style={{backgroundColor:props.myMode==='dark'? '#042743':'white',color:props.myMode==='dark'?'white':'black'}}>
